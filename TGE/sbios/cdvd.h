...
//			0 if error
s32  cdRead(	u32 sectorLoc, u32 numSectors, void *buffer, CdvdReadMode_t *mode, SifRpcEndFunc_t endfunc, void *efarg, int *result);
s32  cdDvdRead(	u32 sectorLoc, u32 numSectors, void *buffer, CdvdReadMode_t *mode, SifRpcEndFunc_t endfunc, void *efarg, int *result);
s32  cdCddaRead(u32 sectorLoc, u32 numSectors, void *buffer, CdvdReadMode_t *mode, SifRpcEndFunc_t endfunc, void *efarg, int *result);
...
// returns:	1 if successful
//			0 otherwise
s32  cdGetToc(u8 *toc, int len, SifRpcEndFunc_t endfunc, void *efarg, int *result);
...
// returns:	1 if successful
//			0 if error
s32  cdStop(SifRpcEndFunc_t endfunc, void *efarg, int *result);
...
// returns:	1 if successful
//			0 if error
s32  cdReadClock(CdvdClock_t *clock, SifRpcEndFunc_t endfunc, void *efarg, int *result);
...
// returns:	1 if successful
//			0 if error
s32  cdWriteClock(const CdvdClock_t *clock, SifRpcEndFunc_t endfunc, void *efarg, int *result);

// gets the type of the currently inserted disc
// 
// returns:	disk type (CDVD_TYPE_???)
CdvdDiscType_t cdGetDiscType(SifRpcEndFunc_t endfunc, void *efarg, int *result);

// gets the last error that occurred
// 
// returns:	error type (CDVD_ERR_???)
s32  cdGetError(SifRpcEndFunc_t endfunc, void *efarg, int *result);
...
// returns:	1 if successful
//			0 if error
s32  cdTrayReq(s32 param, u32 *traychk, SifRpcEndFunc_t endfunc, void *efarg, int *result);
...
// returns:	1 if successful
//			0 if error
s32  cdSetMediaMode(u32 mode, SifRpcEndFunc_t endfunc, void *efarg, int *result);
